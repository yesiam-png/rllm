...
DEFAULT_MODEL_PATH="/mnt/task_wrapper/rl-openandsyn-codegemma-ntponly-1sync-rerun3_step2399-2048-areal-temp0-naive-seed3/global_step_10"
CHECKPOINT_PARENT="$(dirname "$DEFAULT_MODEL_PATH")"

PROJECT='rlvr-sep12-evalonly'
EXPERIMENT='rl-openandsyn-codegemma-ntponly-1sync-rerun3_step2399-2048-areal-temp0-naive-seed3'
