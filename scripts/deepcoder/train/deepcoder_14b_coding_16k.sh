...
if [[ -z "${MODEL_PATH:-}" ]]; then
    MODEL_PATH="/mnt/task_wrapper/openandsyn-codegemma-ntponly-1sync-rerun3_step2399"
fi

PROJECT='rlvr-sep15'
EXPERIMENT='rl-openandsyn-codegemma-ntponly-1sync-rerun3_step2399-2048-areal-temp0-prime'
