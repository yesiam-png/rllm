...
if [[ -z "${MODEL_PATH:-}" ]]; then
    MODEL_PATH="/root/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B/snapshots/d04e592bb4f6aa9cfee91e2e20afa771667e1d4b"
fi

PROJECT='rlvr-sep21'
EXPERIMENT='rl-llama31-8b-2048-areal-temp0-naive-run1'
