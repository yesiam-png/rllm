...
if __name__ == '__main__':
    ...
    #Initialize datasets
    train_datasets = [TrainDataset.Code.LIVECODEBENCH, TrainDataset.Code.PRIMEINTELLECT, TrainDataset.Code.TACO]
    test_datasets = [TestDataset.Code.LIVECODEBENCH, TestDataset.Code.CODEFORCES]
